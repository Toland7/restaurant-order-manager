...
BEGIN
  ...
  RAISE NOTICE 'Company created with ID: % for user: %', v_company_id, NEW.id;
    ...
    INSERT INTO public.profiles (
      ...
      last_name,
      role,
      company_id -- New: Link to the created company
    )
    VALUES (
      NEW.id,
      ...
      v_company_id -- New: Link to the created company
    );
    ...
    INSERT INTO public.in_app_profiles (user_id, profile_name, position, company_id) -- New: Link to the created company
    VALUES (
      NEW.id,
