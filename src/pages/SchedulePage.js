...
import { Calendar, ChevronDown, Edit3, Trash2, Lock, PlusCircle, Send, CheckCircle, Users, Search, Check, Plus } from 'lucide-react';
                    ...
                    <div key={order.id} className="glass-card p-0 h-full flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
                        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                            ...
                            {isProUser && multiOrders.length > 1 && (
                                <button onClick={() => removeOrder(order.id)} className="text-gray-400 hover:text-red-500 transition-colors p-1" title="Rimuovi ordine" disabled={isSubmitting}>
                                    <Trash2 size={18} />
                                </button>
                            )}
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select 
                                        ...
                                        onChange={(e) => updateOrder(order.id, 'supplier', e.target.value)} 
                                ...
                                <>
                                            ...
                                            <div className="bg-gray-50 dark:bg-gray-900/30 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                                                <div className="max-h-64 overflow-y-auto custom-scrollbar p-2 space-y-1">
                                                    {supplierData.products
                                                        ...
                                                        .map(product => {
                                                            const productId = `schedule-product-${order.id}-${product.replace(/\s+/g, '-')}`;
                                                                    ...
                                                                    {isSelected && (
                                                                        <div className="flex items-center animate-fadeIn">
                                                                            <input 
                                                                                ...
                                                                                onBlur={(e) => updateOrder(order.id, 'items', { ...order.items, [product]: e.target.value })} 
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            onChange={(e) => updateOrder(order.id, 'additional', e.target.value)} 
